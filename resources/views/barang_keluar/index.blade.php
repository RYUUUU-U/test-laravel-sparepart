        ...
        <form method="GET" action="{{ route('barang-keluar.index') }}">
            ...
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-4">
                    ...
                    <a href="{{ route('barang-keluar.index') }}" class="btn btn-secondary btn-sm"><i class="fa-solid fa-rotate"></i> Reset</a>
...
<div class="card shadow mb-4">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        ...
        <form method="GET" action="{{ route('barang-keluar.index') }}" class="d-flex align-items-center">
